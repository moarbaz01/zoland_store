    ...
    <div className="bg-black text-white py-12">
      <div className="max-w-screen-xl mx-auto px-4">
        ...
        <div className="space-y-6 text-lg text-gray-300">
          <p>
            This privacy policy sets out how ZolandStore uses and protects any
            information that you give ZolandStore when you visit their website
            and/or agree to purchase from them. We are committed to ensuring
          ...
          <p>
            ...
            incorrect or incomplete, please write to Y80/B Mission Vengthlang
            Aizawl MIZORAM 796001, or contact us at zolandstore23@gmail.com as
            soon as possible. We will promptly correct any information found to
            be incorrect.
          </p>
        </div>
      </div>
